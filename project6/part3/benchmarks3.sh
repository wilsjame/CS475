...
echo "*** Project 6 Part Three ArrayMultReduce Benchmarks ***"
...
foreach m ( 1024 2048 4096 32768 131072 524288 1048576 2097152 4194304 8388608   )
	...
	foreach n ( 16 32 128 256 512 1024 )
		...
		g++ -DNUM_ELEMENTS=$m -DLOCAL_SIZE=$n ArrayMultReduce.cpp /scratch/cuda-7.0/lib64/libOpenCL.so -o ArrayMultReduce -lm -fopenmp
		./ArrayMultReduce
